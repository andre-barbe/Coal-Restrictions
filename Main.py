...
simulation_list = ['10', '11', '20', '21', '30', '31', '40', '41', '50', '51']
...
for x in simulation_list:
    CreateSTI("coal","coal{0}".format(x)).create()
...
database = ImportCSV("coal", simulation_list).create()
PostEstimation(database).create()
ExportTables("coal", database,simulation_list_normal,simulation_list_marginal).create()
