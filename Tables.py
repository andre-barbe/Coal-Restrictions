...
class ExportTables(object):
    ...
    def create(self) -> None:
        ...
        line_list = ["Table 1: Changes in U.S. Coal Trade (Percent)\n",
                     ...
                     self.create_variable_line("Production", "qo", "Linear", "Coal", "USA", self.simulations_normal),
                     self.create_variable_line("Imports", "qiw", "Linear", "Coal", "USA", self.simulations_normal),
                     self.create_variable_line("Exports", "qxw", "Linear", "Coal", "USA", self.simulations_normal),
                     "\n",
                     "\n",
                     "\n",
                     ...
                     "\tCoal Intensity Reduction Policy (percent)\n",
                     "\t" + "\t".join(self.simulations_normal) + "\n",
                     self.create_variable_line("Production", "qo", "Linear", "Coal", "NonUS", self.simulations_normal),
                     self.create_variable_line("Imports", "qiw", "Linear", "Coal", "NonUS", self.simulations_normal),
                     self.create_variable_line("Exports", "qxw", "Linear", "Coal", "NonUS", self.simulations_normal),
                     "\n",
                     "\n",
                     "\n",
                     ...
                     "\t" + self.create_variable_line("U.S.", "gco2", "Changes", "USA", "Total", self.simulations_normal),
                     ...
                     "\t" + self.create_variable_line("Total World", "gco2", "Changes", "Total", "Total",
                                                      self.simulations_normal),
                     "\n",
                     self.create_variable_line("Change in Total U.S. Emissions (percent)", "gco2", "Levels", "USA",
